...
function getSampleTransactions() {
    const transactions = [
        ...
        { id: '2', name: 'Stripe Payment', description: 'Customer payment received', amount: 28700, category: 'Revenue', categoryColor: '#3B82F6', account: 'Chase Business', date: new Date(Date.now() - 86400000), status: 'completed' },
    ...
    const totalOutflow = Math.abs(transactions.filter(t => t.amount < 0).reduce((sum, t) => sum + t.amount, 0))
