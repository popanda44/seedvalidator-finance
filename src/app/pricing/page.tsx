...
const faqs = [
    {
        ...
        answer: "You get full access to all features in your selected plan for 14 days. No credit card required to start. You can upgrade, downgrade, or cancel anytime.",
    },
    {
    ...
    },
    {
        ...
        answer: "We accept all major credit cards (Visa, Mastercard, American Express) and can arrange invoicing for annual Enterprise contracts.",
    },
    {
        question: "Is my financial data secure?",
        answer: "Yes. We use bank-level 256-bit encryption, are SOC 2 Type II compliant, and never store your bank credentials. We use Plaid for secure connections.",
    },
    {
        question: "Do you offer discounts for annual billing?",
        answer: "Yes! You save 20% when you choose annual billing. Contact our sales team for custom enterprise pricing.",
    },
];
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Choose the plan that fits your stage. All plans include a 14-day free trial.
