                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Have questions about SeedValidator? We&apos;d love to hear from you.
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:hello@seedvalidator.com" className="text-muted-foreground hover:text-primary transition-colors">
