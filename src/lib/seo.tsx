...
const siteConfig = {
  name: 'FinYeld AI',
  description:
    'AI-powered financial intelligence platform for startups. Real-time analytics, predictive forecasting, and investor-ready insights that maximize your yield.',
...
export function generateOrganizationSchema() {
  return {
    ...
    description: siteConfig.description,
    sameAs: ['https://twitter.com/finyeldai', 'https://linkedin.com/company/finyeld-ai'],
    contactPoint: {
      '@type': 'ContactPoint',
