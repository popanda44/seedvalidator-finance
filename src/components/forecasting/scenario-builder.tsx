...
import { Plus, Trash2, TrendingUp, Palette, Percent, DollarSign } from 'lucide-react'
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[400px] bg-white dark:bg-slate-900">
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to delete &ldquo;{scenarioName}&rdquo;? This action cannot be
            undone.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter className="gap-2 sm:gap-0">
