...
export function AnimatedCounter({
  ...
  const formattedValue = formatFn ? formatFn(displayValue) : displayValue.toFixed(decimals)
...
export function AnimatedMonths({ value, className, duration = 1200 }: AnimatedMonthsProps) {
  return (
    <AnimatedCounter
      value={value}
      decimals={1}
