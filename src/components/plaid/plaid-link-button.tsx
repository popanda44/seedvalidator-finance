...
import { Building2, CheckCircle2, Loader2, AlertCircle, ExternalLink } from 'lucide-react'
      ...
      <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogTitle className="text-center">Bank Connected Successfully!</DialogTitle>
