...
export const AIChatPreview = () => {
  const [messages, setMessages] = useState([
    ...
    {
      role: 'assistant',
      content: 'Based on recent transactions, your average burn rate is $45,200.',
    },
    { role: 'user', content: 'How does that affect runway?' },
    {
      role: 'assistant',
      content:
        'With your cash balance of $520k, you have approximately 11.5 months of runway left. I suggest reviewing the AWS spend surge.',
    },
  ])
