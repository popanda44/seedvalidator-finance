        ...
        <div className="w-full max-w-2xl mx-auto p-1 relative z-20">
            ...
            <div className="relative bg-card/50 dark:bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-8">
                    ...
                    <div className="text-right">
                        ...
                        <div className={cn(
                            ...
                            runway > 12 ? "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" :
                                runway > 6 ? "bg-amber-500/10 text-amber-400 border-amber-500/20" :
                ...
                <div className="h-32 w-full mb-8 flex items-end justify-between gap-1 relative overflow-hidden">
                    ...
                    <svg className="w-full h-full absolute inset-0 text-indigo-500/50" viewBox={`0 0 ${data.length} 100`} preserveAspectRatio="none">
                        <path
                ...
                <div className="space-y-6">
                    <div className="space-y-3">
                        <div className="flex justify-between">
                            ...
                            <span className="text-sm tabular-nums font-mono text-muted-foreground">${cash.toLocaleString()}</span>
                        </div>
                        <Slider
                            value={[cash]}
                            min={0}
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between">
                            ...
                            <span className="text-sm tabular-nums font-mono text-muted-foreground">${burn.toLocaleString()}</span>
                        </div>
                        <Slider
                            value={[burn]}
                            min={1000}
